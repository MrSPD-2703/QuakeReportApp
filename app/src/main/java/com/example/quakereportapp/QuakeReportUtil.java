...
import java.util.ArrayList;
    ...
    public class QuakeReportUtil {
        ...
        /**
         * Create a private constructor because no one should ever create a {@link QuakeReportUtil} object.
         * This class is only meant to hold static variables and methods, which can be accessed
         * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
         */
        private QuakeReportUtil() {
        }
        ...
        public static ArrayList<Earthquake> extractEarthquakes() {
            ...
            try {
                ...
                for (int i =0 ; i< jsonArray.length() ; i++){
                    ...
                    JSONObject  propertyObject = currentObject.getJSONObject("properties");
                    String mag = propertyObject.getString("mag");
